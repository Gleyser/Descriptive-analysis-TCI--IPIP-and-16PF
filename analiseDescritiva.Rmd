...
```{r}
options(scipen = 999)
plotNormalHistogram (dados$tci_TeamVision)

qqnorm (dados$tci_TeamVision,
       ylab = "Sample Quantiles for Team Vision")
qqline (dados$tci_TeamVision,
       col = "red")
shapiro.test(dados$tci_TeamVision)

T_log = log(dados$tci_TeamVision)
...
T_log10 = log10(dados$tci_TeamVision)
...
T_log2 = log2(dados$tci_TeamVision)
...
T_tuk =  transformTukey (dados$tci_TeamVision,
                     plotit = FALSE)
